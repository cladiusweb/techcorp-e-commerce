...
// Static fallback data for instant hydration or offline states
export const fallbackProducts: Product[] = [
  ...
  },
  {
    ...
    specs: {
      'Kasa': '49 mm Titanyum, 100m Su Geçirmezlik',
...
export async function getProducts(params?: {
  ...
  try {
    ...
    console.warn('API error, falling back to static items:', error);
  }
...
export async function getProductById(id: string): Promise<Product | null> {
  try {
    ...
    console.warn('API error fetching product by id:', error);
  }
